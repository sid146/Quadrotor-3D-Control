...
h_fig = figure;
h_3d = gca;  %gca Get handle to current axis.
...
axis equal
grid on
view(3); % 3-D graph viewpoint specification.
xlabel('x [m]'); ylabel('y [m]'); zlabel('z [m]')
quadcolors = lines(1);

set(gcf,'Renderer','OpenGL') %H = gcf returns the handle of the current figure. The current
